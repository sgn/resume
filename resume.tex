...
\item \resdesc{C}{highly fluent, used occasionally at work.}
...
\item \resdesc{git}{fluent enough to support other colleagues recovering from
  most of disasters.}
\item \resdesc{Linux}{proficient, having used full time at home.}
\end{itemize}
...
\resemployer[Software Engineer]{\href{https://www.larion.com/}{Larion}}
  ...
  \resjob[Developing module to process data for a financial analysis firm.
    \begin{itemize}
	\item Analyse, parse received data, then convert to internal data
		format.
	\item Written in \cplusplus{} on Linux
    \end{itemize}]
		{Mars}{Now}{Feb. 2019}
